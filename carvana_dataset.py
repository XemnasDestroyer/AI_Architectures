...
class CarvanaDataset(Dataset):
    def __init__(self, root_path, test=False):
        ...
        if test:
            ...
            self.images = sorted([root_path+"\\train_small\\"+i for i in os.listdir(root_path+"\\train_small\\")])
            self.masks = sorted([root_path+"\\train_small_masks\\"+i for i in os.listdir(root_path+"\\train_small_masks\\")])
